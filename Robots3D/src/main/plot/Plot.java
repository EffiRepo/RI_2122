...
public class Plot{
    ...
    public static final int[] colorLine = new int[]{
             world.color(255,0,0,255),
            world.color(0,255,0,255),
            world.color(0,0,255,255),
            world.color(153, 102, 204,255),
            world.color(255, 126, 0,255),
            world.color(222, 93, 131,255),
    };
    ...
    public Plot(String title, int xPos, int yPos, int width, int height)  {
        ...
        this.width = width;
        this.height = height;
        titleBg = world.color(214,182,75);
        gridLineColor = world.color(50,50,50);
        gridColor = world.color(255, 255, 204);
        canvasColor = world.color(0,0,0);
        referenceLineColor = world.color(204, 0, 0);
        setGridHeight();
        pGraphics = world.createGraphics(width,height);
        boundYSup=-1f;
        boundYInf=-1f;
    ...
    public void setTitleBackground(int r, int g, int b){
        this.titleBg = world.color(r,g,b);

    }
    public void setTitleColor(int r, int g, int b){
        this.titleColor = world.color(r,g,b);

    }
    public void setGridBackgroundColor(int r, int g, int b){
        this.gridLineColor = world.color(r,g,b);
    ...
    public void drawVal() {
        ...
        if (visible) {
            ...
            world.image(pGraphics, xPos, yPos);
    ...
    public ArrayList<ArrayList<Float>> getValToPlot() {
        return valToPlot;
    }
}